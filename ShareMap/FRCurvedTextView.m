...
- (void)setupAttributedString {
    ...
    CTFontRef fontRef = CTFontCreateWithName((__bridge CFStringRef)(self.textFont), self.textSize, NULL); //1
    
    NSDictionary *attrDictionary = [NSDictionary dictionaryWithObjectsAndKeys:
                                    (__bridge id)fontRef, kCTFontAttributeName, nil];
...
- (void)setupDrawRectParameters {
    ...
    _line = CTLineCreateWithAttributedString((__bridge CFAttributedStringRef)(self.attString));//7
